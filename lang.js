...
function lang() {
    return {
        ...
        "bg":{
            ...
            "faq_content" : "Ще подписвам договор, как да разбера дали всичко в него е наред? <br/> <strong>- Изпрате ни договора си, ние ще ви посъветваме. Разбира се, всичко остава конфиденциално.</strong> <br/><br/> Имам съмнения дали Работодателят ми постъпва коректно и не знам как да реагирам, какви са правата ми? <br/> <strong>- Разкажете ни случая си и ние ще ви дадем конкретни съвети и разяснения.</strong> <br/><br/> Искат да ме уволнят, карат ме да подписвам, спешно е! <br/> <strong>- Не се поддавайте на натиск, не подписвайте нищо, обадете ни се! Ние ще ви помогнем!</strong> <br/><br/> В сводното си време заработвам допълнително, как да направя така, че всичко да е законно и изгодно? <br/> <strong>- Ние сме специализирани в търговско и трудово право, изпрате ни случая си и ще ви помогнем с изготвяне на правилните документи и пускането им до правилните места, така че да извлечете максимума от ситуацията. </strong> <br/><br/>Искам да започна работа за хора от чужбина, какъв е най-добрият вариант за мен? <br/><strong>- Свържете се с нас и ще ви посъветваме в зависимост от локацията, за която става дума.</strong> <br/><br/>Имам нужда от правен съвет, но нямам време да ходя по кантори, може ли да свършим работа онлайн? <br/><strong>- Ние сме наясно колко ценно е Вашето време, винаги можете да ни намерите онлайн по всички възможни канали. А, ние ще се постараем да решим случая ви с никакво или минимално разкарване.</strong>"
        }
    }
}
