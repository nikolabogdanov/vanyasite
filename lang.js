...
function lang() {
    return {
        ...
        "bg":{
            ...
            "firms" : "Фирми",
            "firmRegistration" : "Регистрация на Фирми",
            ...
            "freelancerModalText" : "Да подпиша ли този договор? Защитава ли добре правата ми? <br/>Кой е най-добрият законов вариант да работя като фриленсър? <br/>Съвместяване на работа на трудов договор и работа като фриленсър?",
            "subscription" : "Абонаментно правно обслужване.",
            "lawConsultance" : "Юридически консултации и становища.",
            "documentReview" : "Преглед на документи.",
            "contactUs" : "Свържете се с нас: ",
            "freelancerLawServices" : "Правни услуги за Фриленсъри",
            "firmRegistrationContent" : "Трябва ми фирма, как да я регистрирам? <br/>Имам нужда от помощ при изготвянето и подаването на документите... <br/>Искам да сменя управителя..." 
        }
    }
}
